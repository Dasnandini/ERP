...
export default function CompanySetupPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-6 relative overflow-hidden bg-[radial-gradient(ellipse_80%_60%_at_50%_0%,rgba(16,185,129,0.12),transparent)]">
      <div className="w-full max-w-2xl bg-white border border-slate-200/80 rounded-2xl p-8 shadow-2xl shadow-emerald-950/5 relative z-10">
        {/* Brand Header */}
        ...
        <h1 className="text-2xl font-bold text-slate-900 tracking-tight mb-1">Setup your company</h1>
                ...
                <div
                  className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold transition-all duration-300 ${
                    isCompleted
                      ...
                      : isActive
                      ? "bg-gradient-to-br from-emerald-500 to-teal-600 text-white ring-2 ring-emerald-400 shadow-md shadow-emerald-500/20"
        ...
        <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-5">
          ...
          {currentStep === 1 && (
            <div className="flex flex-col gap-4">
              <div className="flex flex-col gap-1.5">
                <label className="text-xs font-semibold text-slate-700" htmlFor="company-name">
                  Company Name <span className="text-red-500">*</span>
                </label>
                <input
                  id="company-name"
                  type="text"
                  className={`w-full px-3.5 py-2.5 bg-slate-50 border ${fieldErrors.name ? "border-red-400" : "border-slate-200"} rounded-xl text-slate-900 text-sm placeholder-slate-400 focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 transition-all`}
                ...
                />
                {fieldErrors.name && (
                  <span className="text-xs text-red-500">{fieldErrors.name[0]}</span>
                )}
              </div>

              <div className="grid grid-cols-2 gap-3">
                <div className="flex flex-col gap-1.5">
                  <label className="text-xs font-semibold text-slate-700" htmlFor="company-phone">
                    Phone Number <span className="text-red-500">*</span>
                  </label>
                  <input
                    id="company-phone"
                    type="tel"
                    className={`w-full px-3.5 py-2.5 bg-slate-50 border ${fieldErrors.phone ? "border-red-400" : "border-slate-200"} rounded-xl text-slate-900 text-sm placeholder-slate-400 focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 transition-all`}
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="text-xs font-semibold text-slate-700" htmlFor="company-email">
                    Company Email
                  </label>
                  <input
                    id="company-email"
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="flex flex-col gap-1.5">
                  <label className="text-xs font-semibold text-slate-700" htmlFor="company-website">
                    Website URL
                  </label>
                  <input
                    id="company-website"
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="text-xs font-semibold text-slate-700" htmlFor="company-industry">
                    Industry
                  </label>
                  <select
                    id="company-industry"
                    className="w-full px-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-slate-900 text-sm focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 transition-all"
                    value={industry}
          ...
          {currentStep === 2 && (
            <div className="flex flex-col gap-4">
              <div className="flex flex-col gap-1.5">
                <label className="text-xs font-semibold text-slate-700" htmlFor="logo-url">
          ...
          {currentStep === 3 && (
            <div className="flex flex-col gap-4">
              <div className="flex flex-col gap-1.5">
                <label className="text-xs font-semibold text-slate-700" htmlFor="address-line1">
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-xs font-semibold text-slate-700" htmlFor="address-line2">
                  Address Line 2
                </label>
                <input
                  id="address-line2"
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="flex flex-col gap-1.5">
                  <label className="text-xs font-semibold text-slate-700" htmlFor="address-city">
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="text-xs font-semibold text-slate-700" htmlFor="address-state">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="flex flex-col gap-1.5">
                  <label className="text-xs font-semibold text-slate-700" htmlFor="address-country">
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="text-xs font-semibold text-slate-700" htmlFor="address-postalcode">
          ...
          {currentStep === 4 && (
            <div className="flex flex-col gap-4">
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="text-xs font-semibold text-slate-700" htmlFor="timezone">
                    Timezone
                  </label>
                  <select
                    id="timezone"
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="flex flex-col gap-1.5">
                  <label className="text-xs font-semibold text-slate-700" htmlFor="gst-number">
                    GST Number (Optional)
                  </label>
                  <input
                    id="gst-number"
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="text-xs font-semibold text-slate-700" htmlFor="pan-number">
                    PAN Number (Optional)
                  </label>
                  <input
                    id="pan-number"
